...
import THREE from '../../common/threejs/three.js'
import MTLLoader from '../../common/threejs/MTLLoader.js'
console.log("OBJMTL---------------");
...
THREE.OBJMTLLoader.prototype = {
	...
	load: function ( url, mtlfileurl, options ) {
		...
		var mtlLoader = new MTLLoader( url.substr( 0, url.lastIndexOf( "/" ) + 1 ), options );
...
var OBJMTLLoader = THREE.OBJMTLLoader;
